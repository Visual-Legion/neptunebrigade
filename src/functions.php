...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // polyfill
            wp_register_script('polyfill', get_template_directory_uri() . '/js/lib/polyfill.js', array(), '6.26.1');
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'header-menu' => __('Header Menu', 'vl_textdomain'), // Main Navigation
        'sidebar-menu' => __('Sidebar Menu', 'vl_textdomain'), // Sidebar Navigation
        'extra-menu' => __('Extra Menu', 'vl_textdomain') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Widget Area 1', 'vl_textdomain'),
        'description' => __('Description for this widget-area...', 'vl_textdomain'),
        'id' => 'widget-area-1',
    ...
    register_sidebar(array(
        'name' => __('Widget Area 2', 'vl_textdomain'),
        'description' => __('Description for this widget-area...', 'vl_textdomain'),
        'id' => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
//         array(
//         'labels' => array(
//             'name' => __('Photo Gallery', 'vl_textdomain'), // Rename these to suit
//             'singular_name' => __('Photo Gallery', 'vl_textdomain'),
//             'add_new' => __('Add New', 'vl_textdomain'),
//             'add_new_item' => __('Add New Photo Gallery', 'vl_textdomain'),
//             'edit' => __('Edit', 'vl_textdomain'),
//             'edit_item' => __('Edit Photo Gallery', 'vl_textdomain'),
//             'new_item' => __('New Photo Gallery', 'vl_textdomain'),
//             'view' => __('View Photo Gallery', 'vl_textdomain'),
//             'view_item' => __('View Photo Gallery', 'vl_textdomain'),
//             'search_items' => __('Search Photo Gallery', 'vl_textdomain'),
//             'not_found' => __('No Photo Galleries found', 'vl_textdomain'),
//             'not_found_in_trash' => __('No Photo Galleries found in Trash', 'vl_textdomain')
//         ),
//         'public' => true,
...
//         array(
//         'labels' => array(
//             'name' => __('Event', 'vl_textdomain'), // Rename these to suit
//             'singular_name' => __('Event', 'vl_textdomain'),
//             'add_new' => __('Add New', 'vl_textdomain'),
//             'add_new_item' => __('Add New Event', 'vl_textdomain'),
//             'edit' => __('Edit', 'vl_textdomain'),
//             'edit_item' => __('Edit Event', 'vl_textdomain'),
//             'new_item' => __('New Event', 'vl_textdomain'),
//             'view' => __('View Event', 'vl_textdomain'),
//             'view_item' => __('View Event', 'vl_textdomain'),
//             'search_items' => __('Search Event', 'vl_textdomain'),
//             'not_found' => __('No Events found', 'vl_textdomain'),
//             'not_found_in_trash' => __('No Events found in Trash', 'vl_textdomain')
//         ),
//         'public' => true,
...
if(is_admin()){ 
    require_once('my-theme-settings.php');
}
 ...
 * @return array
 */
function vl_get_global_options(){
     
    $vl_option = array();
 
    $vl_option  = get_option('vl_options');
